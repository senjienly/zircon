...
#define AML_UART_CONTROL_XMITLEN   (1 << 20)
#define AML_UART_CONTROL_XMITLEN_MASK   (0x3 << 20)
#define AML_UART_CONTROL_PAREN     (1 << 19)
#define AML_UART_CONTROL_PARTYPE   (1 << 18)
#define AML_UART_CONTROL_STOPLEN   (1 << 16)
#define AML_UART_CONTROL_STOPLEN_MASK   (0x3 << 16)
